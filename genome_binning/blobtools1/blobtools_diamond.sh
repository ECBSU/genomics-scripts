...
/apps/unit/HusnikU/blobtools/blobtools create -i scaffolds.fasta -y spades -t scaffolds_v_sprot.diablastx2.taxified.out --db /home/y/yong-phua/blobtaxid/nodesDB.txt 
